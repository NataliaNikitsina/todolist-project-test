...
export const { changeThemeModeAC, setAppStatusAC, setAppErrorAC, setAppLoginAC } = appSlice.actions
export const { selectThemeMode, selectStatus, selectAppError, selectAppLogin } = appSlice.selectors
